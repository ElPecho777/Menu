...
do
    ...
    function sections:Toggle(info)
        ...
        --
        utility:LoadImage(toggle__gradient, "gradient", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradientdown.png")
        --
        function toggle:Get()
        ...
        function toggle:Colorpicker(info)
            ...
            --
            if transp then
                utility:LoadImage(colorpicker__transparency, "cptransp", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/transp.png")
            end
            utility:LoadImage(colorpicker__gradient, "gradient", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradientdown.png")
            --
        ...
        function toggle:Keybind(info)
            ...
            --
            utility:LoadImage(keybind__gradient, "gradient", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradientdown.png")
            --
    ...
    function sections:Slider(info)
        ...
        --
        utility:LoadImage(slider__gradient, "gradient", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradientdown.png")
        --
    ...
    function sections:Button(info)
        ...
        --
        utility:LoadImage(button_gradient, "gradient", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradientdown.png")
        --
        library.began[#library.began + 1] = function(Input)
    ...
    function sections:Dropdown(info)
        ...
        utility:LoadImage(dropdown__gradient, "gradient", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradientdown.png")
        --
                ...
                elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + dropdown.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + dropdown.axis + 15 +  20}) and not window:IsOverContent() then
                    if not dropdown.open then
                        ...
                        for i,v in pairs(options) do
                            ...
                            --
                            utility:LoadImage(dropdown_value_gradient, "gradient", "https://i.imgur.com/Vauscll.png")]]
                            --
    ...
    function sections:Multibox(info)
        ...
        utility:LoadImage(multibox__gradient, "gradient", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradientdown.png")
        --
                ...
                elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + multibox.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + multibox.axis + 15 +  20}) and not window:IsOverContent() then
                    if not multibox.open then
                        ...
                        for i,v in pairs(options) do
                            ...
                            --
                            utility:LoadImage(multibox_value_gradient, "gradient", "https://i.imgur.com/Vauscll.png")]]
                            --
    ...
    function sections:ConfigBox(info)
        ...
        --
        utility:LoadImage(configLoader_gradient, "gradient", "https://raw.githubusercontent.com/f1nobe7650/other/main/uis/osiris/gradientdown.png")
        --
