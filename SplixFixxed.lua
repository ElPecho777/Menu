...
do
    ...
    function sections:Toggle(info)
        ...
        --
        utility:LoadImage(toggle__gradient, "gradient", " https://github.com/f1nobe7650/other/blob/main/uis/osiris/gradient.png?raw=true")
        --
        function toggle:Get()
        ...
        function toggle:Colorpicker(info)
            ...
            --
            if transp then
                utility:LoadImage(colorpicker__transparency, "cptransp", "https://github.com/f1nobe7650/other/blob/main/uis/osiris/cptransp.png?raw=true")
            end
            utility:LoadImage(colorpicker__gradient, "gradient", " https://github.com/f1nobe7650/other/blob/main/uis/osiris/gradient.png?raw=true")
            --
        ...
        function toggle:Keybind(info)
            ...
            --
            utility:LoadImage(keybind__gradient, "gradient", " https://github.com/f1nobe7650/other/blob/main/uis/osiris/gradient.png?raw=true")
            --
    ...
    function sections:Slider(info)
        ...
        --
        utility:LoadImage(slider__gradient, "gradient", " https://github.com/f1nobe7650/other/blob/main/uis/osiris/gradient.png?raw=true")
        --
    ...
    function sections:Button(info)
        ...
        --
        utility:LoadImage(button_gradient, "gradient", " https://github.com/f1nobe7650/other/blob/main/uis/osiris/gradient.png?raw=true")
        --
        library.began[#library.began + 1] = function(Input)
    ...
    function sections:Dropdown(info)
        ...
        utility:LoadImage(dropdown__gradient, "gradient", " https://github.com/f1nobe7650/other/blob/main/uis/osiris/gradient.png?raw=true")
        --
    ...
    function sections:Multibox(info)
        ...
        utility:LoadImage(multibox__gradient, "gradient", " https://github.com/f1nobe7650/other/blob/main/uis/osiris/gradient.png?raw=true")
        --
    ...
    function sections:ConfigBox(info)
        ...
        --
        utility:LoadImage(configLoader_gradient, "gradient", " https://github.com/f1nobe7650/other/blob/main/uis/osiris/gradient.png?raw=true")
        --
